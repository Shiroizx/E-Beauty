    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4 mb-0"><i class="fas fa-edit me-2"></i> Edit Promo: {{ $promo->name }}</h2>
                    ...
                    <form action="{{ route('admin.promos.update', $promo->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="discount_value" class="form-control" value="{{ old('discount_value', $promo->discount_value) }}" required min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="datetime-local" name="start_date" class="form-control" value="{{ old('start_date', $promo->start_date->format('Y-m-d\TH:i')) }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tanggal Berakhir <span class="text-danger">*</span></label>
                                <input type="datetime-local" name="end_date" class="form-control" value="{{ old('end_date', $promo->end_date->format('Y-m-d\TH:i')) }}" required>
                            </div>
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Batas Penggunaan (Optional)</label>
                            <input type="number" name="usage_limit" class="form-control" value="{{ old('usage_limit', $promo->usage_limit) }}" min="0">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Minimum Pembelian (Optional)</label>
                            <input type="number" name="min_purchase_amount" class="form-control" value="{{ old('min_purchase_amount', $promo->min_purchase_amount) }}" min="0">
                        </div>
                            ...
                            <div class="card p-2" style="max-height: 200px; overflow-y: auto;">
                                @foreach($products as $product)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="product_ids[]" value="{{ $product->id }}" id="p{{ $product->id }}" 
                        ...
                        <div class="form-check form-switch mb-4">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1" id="isActive" {{ $promo->is_active ? 'checked' : '' }}>
