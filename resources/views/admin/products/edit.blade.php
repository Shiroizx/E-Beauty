    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="h4 mb-0"><i class="fas fa-edit me-2"></i> Edit Produk: {{ $product->name }}</h2>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($product->image)
                                        <div class="mb-2">
                                            <img src="{{ $product->image_url }}" alt="Preview" class="img-thumbnail" style="height: 100px;">
                                        </div>
                                    @endif
                                    ...
                                    <div class="card p-2" style="max-height: 200px; overflow-y: auto;">
                                        @foreach($skinTypes as $skinType)
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="skin_type_ids[]" value="{{ $skinType->id }}" id="st{{ $skinType->id }}" 
